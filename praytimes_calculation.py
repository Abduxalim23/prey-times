'''
Index » PrayTimes : Blob ce20d8 / v2 / python / praytimes.py
Summary | Shortlog | Commit | Commitdiff | Tree | 
commit
 
Last commit for v2/python/praytimes.py: 971d9f097150ae5eb5940470fb71c64a70b13194
...
if __name__ == "__main__":
	...
	'''
	times = prayTimes.getTimes(date(2021,11,25), (40.708369169314714, 72.06034237298016, 460), 5);
	for i in ['Fajr', 'Sunrise', 'Dhuhr', 'Asr', 'Maghrib', 'Sunset', 'Isha', 'Midnight']:
		print(i+ ': '+ times[i.lower()])
	'''
	times = prayTimes.getTimes(date(2021,11,20), (40.708369169314714, 72.06034237298016, 460), 5);
	for i in ['Fajr', 'Sunrise', 'Dhuhr', 'Asr', 'Maghrib', 'Sunset', 'Isha', 'Midnight']:
		print(i+ ': '+ times[i.lower()])
		#print(type(times[i.lower()]))